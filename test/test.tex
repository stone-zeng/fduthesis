...
%\immediate\write18{extractbb fudan-name-black.pdf}
%\immediate\write18{extractbb fudan-emblem-new-a-blue.pdf}
%\immediate\write18{extractbb fudan-emblem-new-b-red.pdf}
...
劝学        &  君子曰：学不可以已。青，取之于蓝，而青于蓝；冰，水为之，而寒于水。木
  直中绳。{"2B413}{"8F2E} 輮以为轮，其曲中规。虽有槁暴，不复挺者，輮使之然也。故木受绳则直，金就
...
%  {\CJKfontspec{FandolFang}[Mapping=full-stop] 仿宋句号。}
%\group_end:
%\ExplSyntaxOff

\subsection{句号}
如果 {"002E} 会突然：\textsc{Full Stop} \par
如果 {"3002} 会突然：\textsc{Ideographic Full SStop} \par
如果 {"FF0E} 会突然：\textsc{Fullwidth Full Stop} \par
如果 {"FF61} 会突然：\textsc{Halfwidth Ideographic Full Stop} \par
\clearpage
